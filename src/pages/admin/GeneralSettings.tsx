...
const AdminGeneralSettings = () => {
  ...
  const handleHeroInputBlur = async (id: string, field: keyof HeroImage, value: string) => {
    try {
      ...
      console.log(`Force saving ${field} for hero image ${id}:`, trimmedValue);
      
      // Update local cache immediately for UI responsiveness
      handleHeroInputChange(id, field, trimmedValue || null);
      ...
      toast.success("পরিবর্তন সংরক্ষিত হয়েছে");
    } catch (error) {
      console.error("Failed to save hero field:", error);
      toast.error("সংরক্ষণ করা যায়নি");
      // Revert cache if failed (React Query will do this on invalidate usually, 
      // but manual revert is safer for uncontrolled inputs)
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      toast.success("গ্যালারি রিফ্রেশ করা হয়েছে");
                    }}
                  >
                    গ্যালারি রিফ্রেশ করুন
                  </Button>
                </div>
              </div>
